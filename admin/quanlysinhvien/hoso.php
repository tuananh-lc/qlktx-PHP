...
?>
		...
		<thead>
			<tr>
				<th>Mã SV</th><th>Họ Tên</th><th>Ngày Sinh</th><th>Giới Tính</th><th>Địa Chỉ</th><th>SĐT</th><th>Mật Khẩu</th><th colspan="2">#</th>
			</tr>
		</thead>
		<tbody>
			<?php while ($row=mysqli_fetch_array($rs)) {?>
				...
				<tr>
					...
					<td><input  class="form-control form-control-sm" type="text" name="mk" value="<?php echo $row['MatKhau'] ?>"></td>
					<td><input  class="btn-sm btn-success btn" type="submit" name="action" value="Cập nhật"></td>
					<td><a href="quanlysinhvien/xuly.php?action=xoa&masv=<?php echo $row['MaSV'] ?>"><input class="btn-sm btn-success btn" type="submit" name="action" value="Xóa"></a></td>
				</tr>
				</form>	
	<?php	} ?>
