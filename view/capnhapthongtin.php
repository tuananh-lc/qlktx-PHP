        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form class="form-signin" action="xuly/main.php?action=capnhapthongtin" method="POST">
              ...
              <div class="form-label-group">
              <input type="text" id="inputText" class="form-control" name="sex" placeholder="Họ và Tên" value="<?php echo $row['GioiTinh']?>" required >
              </div>
              <hr>
              ...
              <div class="custom-control custom-checkbox mb-3">
                ...
                <button class="btn btn-lg btn-primary btn-block text-uppercase" name ="sv_capnhaptt" type="submit">Cập nhật thông tin</button>
              <hr class="my-4">
            </form>
          </div>
        </div>
